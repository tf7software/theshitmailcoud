...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createBlogCard(blog) {
        ...
        // Display the first five words of the body followed by "..."
        const bodyPreview = document.createElement('p');
        const bodyWords = blog.body.split(' ');
        const bodyPreviewText = bodyWords.slice(0, 5).join(' ');
        bodyPreview.textContent = `${bodyPreviewText}...`;
        blogCard.appendChild(bodyPreview);
